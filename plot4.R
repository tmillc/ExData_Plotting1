...
# Voltage
plot(power_consumption_subset$DateTime, power_consumption_subset$Voltage,
...
plot(power_consumption_subset$DateTime, power_consumption_subset$Global_reactive_power,
